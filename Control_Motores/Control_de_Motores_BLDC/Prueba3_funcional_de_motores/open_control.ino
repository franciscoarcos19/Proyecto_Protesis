...
//next commands will change the PWM frequency, so the annoying sound generated can be moved above human ear capability.
  ...
  TCCR1B = TCCR1B & 0b11111000 | 0x04; // set PWM frequency @ 31250 Hz for Pins 9 and 10, (0x03 is default value, gives 490 Hz).
  TCCR2B = TCCR2B & 0b11111000 | 0x06; // set PWM frequency @ 31250 Hz for Pins 11 and 3, (0x03 is default value, gives 490 Hz).
